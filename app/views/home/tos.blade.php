<div class="common-container">
    <div align="left">
        <span class="tosHeader" style="font-size:16pt; font-weight:bold; ">Terms of Service for natureprotector.com</span>
    </div>
        <span class="tosTitle" style="font-size:14pt;">Introduction</span>
        <br><br>
        Welcome to natureprotector.com.  This website is owned and operated by natureprotector.com.  By visiting our website and accessing the information, resources, services, products, and tools we provide, you understand and agree to accept and adhere to the following terms and conditions as stated in this policy (hereafter referred to as 'User Agreement'), along with the terms and conditions as stated in our Privacy Policy (please refer to the Privacy Policy section below for more information).
        <br><br>
        This agreement is in effect as of Aug 03, 2013.
        <br><br>
        ...
        vi) no information or advice, whether expressed, implied, oral or written, obtained by you from natureprotector.com or through any Resources we provide shall create any warranty, guarantee, or conditions of any kind, except for those expressly outlined in this User Agreement.<br>
        <br><br><span class="tosTitle" style="font-size:14pt;">Limitation of Liability</span>
        <br><br>
            In conjunction with the Limitation of Warranties as explained above, you expressly understand and agree that any claim against us shall be limited to the amount you paid, if any, for use of products and/or services.  Natureprotector.com will not be liable for any direct, indirect, incidental, consequential or exemplary loss or damages which may be incurred by you as a result of using our Resources, or as a result of any changes, data loss or corruption, cancellation, loss of access, or downtime to the full extent that applicable limitation of liability laws apply.
        <br><br><span class="tosTitle" style="font-size:14pt;">Copyrights/Trademarks</span>
        <br><br>
        All content and materials available on natureprotector.com, including but not limited to text, graphics, website name, code, images and logos are the intellectual property of natureprotector.com, and are protected by applicable copyright and trademark law.  Any inappropriate use, including but not limited to the reproduction, distribution, display or transmission of any content on this site is strictly prohibited, unless specifically authorized by natureprotector.com.
        ...
        <br><br>
        UNLESS OTHERWISE EXPRESSED, natureprotector.com EXPRESSLY DISCLAIMS ALL WARRANTIES AND CONDITIONS OF ANY KIND, WHETHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO THE IMPLIED WARRANTIES AND CONDITIONS OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT.
        <br><br><span class="tosTitle" style="font-size:14pt;">Contact Information</span>
        <br><br>
        If you have any questions or comments about these our Terms of Service as outlined above, you can contact us at:<br><br>natureprotector.com<br><br>  <br>
        <br><br>
</div>